                            ...
                            <tbody class=" ">
                                @foreach ($faculties as $faculty)
                                    <tr class="h-12 ">
                                        ...
                                        <td class="text-center text-xs sm:text-sm md:text-md lg:text-md overflow-x-visible">{{ $faculty->firstname. ' ' . $faculty->lastname }}</td>
                                        ...
                                        <td class="text-center text-xs sm:text-sm md:text-md lg:text-md overflow-x-visible">
                                            ...
                                            {{-- <x-jet-danger-button wire:click="confirmItemDeletion( {{ $faculty->id }})"
