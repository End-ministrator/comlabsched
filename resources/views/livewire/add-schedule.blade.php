<div class="p-5 bg-yellow-300">
    <div class="flex w-full gap-2">
        <div class="flex flex-col mb-3 grow">
            ...
            <input type="time" class=" rounded p-2 shadow-inner text-black shadow-yellow-500 " wire:model="start_time">
            @error('start_time') <span class="text-red-400 text-sm py-1">{{ $message }}</span> @enderror
        </div>
        
        <div class="flex flex-col mb-3 grow">
            <label class="mb-2">End Time</label>
            <input type="time" class=" rounded p-2 shadow-inner text-black shadow-yellow-500" wire:model="end_time">
    ...
    <div class="flex flex-col mb-3 grow">
        ...
        <input class=" rounded p-2 shadow-inner text-black shadow-yellow-500" type="number" value="1" min="1" max="2" wire:model="faculty_id">
    ...
    <button type="submit" class="w-full rounded p-2 text-white bg-blue-500 hover:bg-blue-700 mt-2" wire:click="addSched">Submit</button>
</div>
