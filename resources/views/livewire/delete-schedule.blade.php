<div class="flex flex-col items-center justify-center p-2 bg-white dark:bg-gray-700">
    ...
    <div class="flex space-x-3">
        <button wire:click="deleteSched"
            class="btn btn-danger closeModal  bg-blue-500 w-20 h-8 text-white rounded-lg !important">Delete</button>
        <button wire:click="$emit('closeModal')"
            class="btn btn-secondary  border rounded-lg border-blue-700 w-20 h-8">Cancel</button>
