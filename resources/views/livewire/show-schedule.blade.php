            ...
            <div class="flex p-7 w-full h-screen justify-center items-center">
                <div class="flex flex-col justify-center w-full h-full pb-8 pt-4 my-8 bg-white dark:bg-gray-700 shadow shadow-black rounded-lg">
                    <div class="flex flex-row justify-between">
                        <button onclick="Livewire.emit('openModal', 'add-schedule')" class="btn btn-success btn-sm flex justify-center items-center bg-blue-700 dark:bg-blue-700 hover:bg-blue-600 border ml-14 mt-8 rounded-md border-blue-700 w-32 h-10" id="addfaculty" title="Add New Faculty">
                            <span class="text-lg text-white !important">Add Schedule</span>
                        </button>
                        <!-- date filter -->
                        <div class="flex text-gray-600 ml-8 mt-8 mr-12 space-x-3">
                            <input class="border-2 border-gray-300 bg-white h-10 px-5 rounded-lg text-sm focus:outline-none" type="date" id="filterDate" name="filterDate" placeholder="Filter Date">
                                ...
                                <tbody class="">
                                    ...
                                    <tr class="h-12">
                                        ...
                                        <td class="text-center text-xs sm:text-sm md:text-md lg:text-md overflow-x-visible">
                                            {{ $sch['semester'] }}</td>
                                        <td class="text-center text-xs sm:text-sm md:text-md lg:text-md overflow-x-visible">
                                            <button onclick="Livewire.emit('openModal', 'edit-schedule', { scheduleId: {{ $sch['id'] }}})" class="btn btn-primary btn-sm">
                                                <i class="fa fa-pencil-square-o" aria-hidden="true"></i>|
                                            </button>
                                            <button onclick="Livewire.emit('openModal', 'delete-schedule', { scheduleId: {{ $sch['id'] }}})" class="btn btn-primary btn-sm">
