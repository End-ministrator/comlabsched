...
<script>
    ...
    document.addEventListener("DOMContentLoaded", function () {
        ...
        var dataTable = document.getElementById('tableko');
        var originalTableHTML = dataTable.innerHTML;
        ...
        function applyDateFilter() {
            ...
            if (startDateInput.value === '' || endDateInput.value === '') {
                return; // If either start date or end date is empty, do nothing
            }
        ...
        function clearDateFilter() {
            ...
            dataTable.innerHTML = originalTableHTML; // Restore the original table HTML
        }
    });
    ...
    dsh.classList.remove('dark:bg-blue-800', 'bg-blue-800', 'shadow-inner', 'shadow-blue-800');
    stg.classList.remove('dark:bg-blue-800', 'bg-blue-800', 'shadow-inner', 'shadow-blue-800');
</script>
