                    ...
                    <div class="w-full h-20 flex justify-evenly">
                        <div class="flex  w-full">
                            ...
                            <div class="flex flex-col justify-center mt-6 ml-6 space-y-4">
                                ...
                                <div class="text-white !important ml-6 h-9 w-20 flex items-center justify-center rounded-full bg-blue-500"><span>Admin</span></div>
                            </div>
                        ...
                        <div class="mr-10 flex flex-col justify-between h-72 ">
                            ...
                            <div class="flex justify-end w-1/3 space-x-3 translate-y-96 sm:translate-y-80 md:translate-y-80  lg:translate-y-64">
                                <button id="Gcancel" class=" text-lg px-4 border w-20 h-9 border-blue-700 rounded-lg hidden -inset-y-3">
                                    Cancel
                                </button>
                                <button id="Gsave" class=" text-white !important w-20 h-9 px-4 text-lg bg-blue-700 rounded-lg hidden -inset-y-3">
                                    Save
                                </button>
                            </div>  
            ...
            <div id="password"class="flex flex-col  sm:flex-col md:flex-col lg:flex-row h-128 sm:h-120 md:h-106 lg:h-96 mb-12 justify-self-center w-full  h-140 sm:h-140 md:h-140  lg:h-4/5 bg-white dark:bg-gray-700 shadow rounded-md justify-between items-center">
                 ...
                 <div class="w-11/12 sm:w-11/12 m:w-11/12 lg:w-1/3 h-full  flex flex-col ml-6">
                    ...
                    <div class="flex flex-col justify-between h-full pt-10 pb-8 ">
                        ...
                        <div class="flex justify-end w-1/3 space-x-3 lg:-translate-x-2 sm:mt-10 md:translate-y-44 lg:translate-y-40  mr-12">
                            <button id="Pcancel" class="relative hidden -inset-y-3 rounded-lg px-4 text-lg border border-blue-700 w-20 h-9">
                                Cancel
                            </button>
                            <button id="Psave" class=" text-white !important relative hidden -inset-y-3 rounded-lg px-4 text-lg bg-blue-700 w-20 h-9">
                                Save
                            </button>
                        </div>
                    </div>
