...
<div class="flex flex-col h-screen bg-[url('/images/tree.jpg')] bg-no-repeat bg-cover">
  ...
  <div class="flex h-full">
    ...
    <div class="flex flex-row items-center justify-center mx-24 my-24 basis-4/5">
      <div class="w-60 h-128 basis-1/3 flex  shadow-black shadow-md bg-[url('/images/bgg.jpg')] bg-no-repeat bg-cover rounded-md relative sm:hidden md:hidden lg:block hidden">

      </div>
      <div class="w-30 h-128 basis-1/3 flex sm:w-30 md:36 lg:w-60  bg-violet-700 shadow-black shadow-lg  rounded-md relative flex-col items-center justify-evenly  backdrop-filter backdrop-blur-sm bg-opacity-20 ">
          <div class="ml-4">
              ...
              <form action="/login" method="post" class="flex flex-col basis-4/6 mt-10 ">
                  ...
                  <div class="border-b-2 border-solid border-black my-2 ">
                    <label id="emaillabel" for="email" class="absolute text-black  block my-2 text-sm -translate-y-1">Email</label>
                  ...
                  <br>
                  <div class="border-b-2 border-solid border-black my-2 ">
                    <label for="password" id="passlabel" class=" text-black  block my-2 text-sm absolute transform -translate-y-1 " >Password</label>
