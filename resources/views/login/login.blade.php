...
<div class="flex flex-row items-center justify-center mx-24 my-24 ">
    <div class="w-60 h-112 basis-1/2 flex border shadow-black shadow-md bg-[url('/images/bgg.jpg')] bg-no-repeat bg-cover rounded-md relative inset-x-12 ">

    </div>
    <div class="w-60 h-128 basis-1/2 flex border shadow-black shadow-md bg-scarlet rounded-md relative flex-col items-center justify-evenly  backdrop-filter backdrop-blur-sm bg-opacity-40 ">
        <div>
