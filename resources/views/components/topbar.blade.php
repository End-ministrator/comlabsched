             ...
             <!-- search -->
                ...
                <div>
                    <ul class="flex  flex-row h-full items-center mr-2  ">
                        ...
                        <li class="w-12 h-12 mt-1 sm:hidden md:hidden lg:flex hidden justify-center items-center"><img src="/images/raymond.jpg" alt="" class="rounded-full bg-contain bg-no-repeat h-11 w-11"> </li>
