...
<aside id="nav"
    class="   bg-yellow-300 dark:bg-amber-700 h-screen lg:w-52 md:w-40 w-36 z-50 flex flex-col justify-between  rounded-none shadow-sm shadow-black fixed">
    ...
    <div>
        <ul id="profile"
            class="flex inset-x-4 inset-y-16 relative flex-row h-full items-center mr-2  transition-opacity transition-transform lg:-translate-x-2 lg:opacity-0 md:opacity-100 sm:opacity-100 opacity-100 translate-x-10  ">
            <li class="w-12 h-12 relative mt-2 sm:-inset-x-6 md:-inset-x-3 lg:inset-x-0 -inset-x-6"><img
    ...
    <div class=" flex flex-col text-lg   mb-10 justify-center">
        ...
        <button
            class="w-5/6 grid  rounded-md hover:inset-x-3 transition-all duration-300 py-1 lg:grid-cols-2 md:grid-cols-1 sm:grid-cols-1 -space-x-6 items-center relative group"><i
